...
export default function MessageBoard() {
  ...
  return (
    <motion.section className='h-44 max-w-lg bg-black rounded-xl overflow-y-scroll lg:p-5 p-3 text-sm text-white' transition={{duration: .5}} initial={{opacity: 0}} animate={{opacity: 1}}>
