...
export default function GameInfo() {
  return (
    <section className="absolute top-0 left-0 right-0 bottom-0 flex justify-center lg:items-center z-10 bg-primary bg-opacity-40 backdrop-blur-lg h-screen overflow-y-scroll">
    <Card title={<section className="flex justify-between"><Title type="neon" headingNumber={2} title="Game info" customStyles="text-accent"></Title> <Button type="neon" text="X" customStyles="bg-accent btn-circle"></Button></section>} customStyle="overflow-scroll">
